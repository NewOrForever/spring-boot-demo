...
public class HttpManager {
     ...
     * @param trustSSL
     */
    public HttpManager(int connectionTimeOut, int readTimeout, int connectionRequestTimeout, int maxHttpTryTime, long keepAliveSeconds, MyHttpProxyConfig proxyConfig, boolean trustSSL) {
