 ...
 * Package:com.demo.push.annotation.http
 * Description:
 *
 * @Date:2023/4/3 17:54
 * @Author:qs@1.com
...
public class MyHttpClient {
    ...
    public MyHttpClient(int connectTimeout,
                        int soTimeout,
                        int connectionRequestTimeout,
                        int maxHttpTryTime,
                        long keepAliveSeconds,
                        MyHttpProxyConfig proxyConfig,
                        boolean trustSSL) {
        if (connectTimeout <= 0) {
    ...
    public String execute(String url, String method, Map<String, Object> headers, String body, String contentType) {
        ...
        if (StringUtils.isNotEmpty(body) && request instanceof HttpEntityEnclosingRequestBase) {
            HttpEntity entity;
