...
public class MyApiConfiguration {
    ...
    /**
     * 如果遇到域名请求地址不断变化或需要排查网络耗时等问题，可以开启此接口（方法）功能后，联系技术支持
     * 健康度检查动态开关，true表示开启，否则关闭，不设置则取 {@link #openAnalyseStableDomainSwitch}
     */
    public final static String CHECK_HEALTH_DATA_SWITCH_KEY = "healthy_switch";
    /**
     * 健康检测时间间隔
     */
     ...
     * http请求设置代理，默认不设置
     */
    private MyHttpProxyConfig proxyConfig;
    ...
    public MyHttpProxyConfig getProxyConfig() {
        return proxyConfig;
    }

    public void setProxyConfig(MyHttpProxyConfig proxyConfig) {
    ...
    public boolean equals(Object o) {
        ...
        MyApiConfiguration that = (MyApiConfiguration) o;
